...
class SampleScenario {
  ...
  //include feeders in scenario as usual
    ...
    .feed(myCustomFeeder)
    .feed(randomDigit)
    .feed(randomPhoneNumberFromJson)
    .feed(randomPhoneNumberFromMap)
    .feed(randomE164PhoneNumberFromJson)
    .feed(randomE164PhoneNumberFromMap)
    .feed(randomTollFreePhoneNumberFromJson)
    .feed(randomTollFreePhoneNumberFromMap)
